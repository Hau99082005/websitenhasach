        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="edit-banner?id=<?php echo $_GET['id']  ?>" enctype="multipart/form-data">
                        <?php if (!empty($err)): ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="thumbnail" value="<?php echo $bannerData['image']; ?>" class="file-upload-default">
                            <div class="input-group col-xs-12">
                                <input type="text" name="thumbnail" class="form-control file-upload-info" disabled
                                    placeholder="Upload Image" value="<?php echo isset($bannerData['image']) ? $bannerData['image'] : ''; ?>">
                        ...
                        <a href="banner"><span class="btn btn-light">Cancel</span></a>
                    </form>
                </div>
            </div>
        </div>
