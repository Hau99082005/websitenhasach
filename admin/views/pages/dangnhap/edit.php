...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Edit dangnhap</h4>
                    <p class="card-description">
                        Edit dangnhap
                    </p>
                    <form class="forms-sample" method="POST" action="edit-dangnhap?id=<?php echo $_GET['id']  ?>" enctype="multipart/form-data">
                        <?php if (!empty($err)): ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="thumbnail" value="<?php echo $dangnhapData['image']; ?>" class="file-upload-default">
                            <div class="input-group col-xs-12">
                                <input type="text" name="thumbnail" class="form-control file-upload-info" disabled
                                    placeholder="Upload Image" value="<?php echo isset($dangnhapData['image']) ? $dangnhapData['image'] : ''; ?>">
                        ...
                        <a href="dangnhap"><span class="btn btn-light">Cancel</span></a>
                    </form>
                </div>
            </div>
        </div>
